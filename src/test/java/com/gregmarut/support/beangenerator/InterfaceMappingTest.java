...
/**
 * A class to demonstrate how to use and define custom interface mappings. During bean initialization,
 * a new object is instantiated based on the type of object that is detected. Since interfaces cannot
...
{
	//holds the BeanPropertyGenerator which is used for creating and populating objects with test data
	...
	/**
	 * A test to ensure that List interfaces are correctly instantiated using ArrayList objects instead
	 */
	@Test
	public void testListInterfaceMapping()
	{
		...
		//make sure that the list that was instantiated was actually an ArrayList because of what was
