...
public class InterfaceProxyTest
{
	...
	public void testBean()
	{
		...
		//make sure that the Map.isEmpty returns whatever the default value was set to for "boolean"s in the BeanPropertyGenerator
		//default is set to true
		assertTrue(isEmpty);
		
		//make sure that the Map.size returns whatever the default value was set to for "int"s in the BeanPropertyGenerator
		//default is set to 1
		assertEquals(1, size);
	}
}
