...
/**
 * This class is thrown whenever an attempt to initialize a class could not be completed. Once example
 * might be an attempt to instantiate an interface without properly mapping it to a concrete class in
 * {@link InterfaceMapper}.
 * 
 * @author Greg Marut
 */
